      ...
      mtx.sync {
        ...
        if settings.run {
            ...
            || settings.speedchanged
          {
            ...
            while d.time * Double(settings.slowdown) - timer.simsync < GLContext.time
              - timer.cpusync
  ...
  glContext.makeCurrent {
    ...
    func makegroup(_ oldstate: Int32) {
      let defGroup: [MjuiDef] = [
        ...
        voptMapper(\.skingroup, .checkbyte, name: "Skin 0", state: 2, other: ""),
        voptMapper(\.skingroup, .checkbyte, name: "Skin 1", state: 2, other: "", offsetBy: 1),
        voptMapper(\.skingroup, .checkbyte, name: "Skin 2", state: 2, other: "", offsetBy: 2),
        voptMapper(\.skingroup, .checkbyte, name: "Skin 3", state: 2, other: "", offsetBy: 3),
        voptMapper(\.skingroup, .checkbyte, name: "Skin 4", state: 2, other: "", offsetBy: 4),
        voptMapper(\.skingroup, .checkbyte, name: "Skin 5", state: 2, other: "", offsetBy: 5),
      ]
